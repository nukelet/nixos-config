# this is a dump from github:pjones/plasma-manager
# maybe someday i'll muster the courage to clean it up...
{ inputs, ... }:

{
    programs.plasma = {
        enable = true;
        shortcuts = {
            "ActivityManager"."switch-to-activity-f34a9eda-2c05-486a-b230-0e2ed42c8137" = [ ];
        ...
        configFile = {
            ...
            "kactivitymanagerdrc"."activities"."f34a9eda-2c05-486a-b230-0e2ed42c8137" = "Default";
            "kactivitymanagerdrc"."main"."currentActivity" = "f34a9eda-2c05-486a-b230-0e2ed42c8137";
            "kcminputrc"."Libinput.1267.12586.ELAN0504:01 04F3:312A Touchpad"."ClickMethod" = 2;
            "kcminputrc"."Libinput.1267.12586.ELAN0504:01 04F3:312A Touchpad"."PointerAccelerationProfile" = 2;
            "kcminputrc"."Libinput.1267.12586.ELAN0504:01 04F3:312A Touchpad"."TapAndDrag" = true;
            "kcminputrc"."Libinput.1267.12586.ELAN0504:01 04F3:312A Touchpad"."TapToClick" = true;
            ...
            "kdeglobals"."Shortcuts"."FullScreen" = "Meta+F; Ctrl+Shift+F";
            ...
            "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{6214877b-a9c5-45e5-81a5-9feb68da101d}";
            ...
            "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{5f5b417d-6018-4034-a152-69dd69f193ae}";
            ...
            "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{e1b7a8ee-468c-4e24-97ee-1dafcc3b6a7c}";
            ...
            "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{7f2973a3-9e2a-4282-9678-291ee0173931}";
            ...
            "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{a234340d-91e8-4e3f-a53f-1ea25eb2e2cf}";
            ...
            "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{556382f0-7949-4c73-b3c1-95df1cda73e8}";
            ...
            "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{36c5f947-3247-4393-996f-1d9d84e7d3bc}";
            ...
            "kwinrc"."Desktops"."Id_1" = "2bda3a5c-b77d-4627-82ae-362be01e51b5";
            ...
            "kwinrc"."Tiling.f3502ffc-1cb8-5ee1-a18b-c5bff91a5219"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
